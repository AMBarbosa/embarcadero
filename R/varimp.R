...
#' @param group.cats Logical, whether or not to aggregate the binary variables generated by one-hot encoding of the factor levels of each categorical variable in the output variable importance table, by summing up their proportions of branches used.
#'
#'
#' @export
#'
...
varimp <- function(model, plots=FALSE, group.cats=TRUE) {
